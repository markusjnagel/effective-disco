...
@javax.inject.Named("demoProcess")
@io.quarkus.runtime.Startup()
public class DemoProcessProcess extends org.kie.kogito.process.impl.AbstractProcess<org.kela.DemoProcessModel> {

    public DemoProcessProcess(org.kie.kogito.app.Application app) {
        this(app, new org.kie.kogito.handlers.Countries_getCountry_9_Handler());
    }

    @javax.inject.Inject()
    public DemoProcessProcess(org.kie.kogito.app.Application app, org.kie.kogito.handlers.Countries_getCountry_9_Handler countries_getCountry_9_Handler) {
        super(app, java.util.Arrays.asList(countries_getCountry_9_Handler));
        activate();
    }

    public DemoProcessProcess() {
    }

    @Override()
    public org.kela.DemoProcessProcessInstance createInstance(org.kela.DemoProcessModel value) {
        return new org.kela.DemoProcessProcessInstance(this, value, this.createProcessRuntime());
    }

    public org.kela.DemoProcessProcessInstance createInstance(java.lang.String businessKey, org.kela.DemoProcessModel value) {
        return new org.kela.DemoProcessProcessInstance(this, value, businessKey, this.createProcessRuntime());
    }

    @Override()
    public org.kela.DemoProcessModel createModel() {
        return new org.kela.DemoProcessModel();
    }

    public org.kela.DemoProcessProcessInstance createInstance(org.kie.kogito.Model value) {
        return this.createInstance((org.kela.DemoProcessModel) value);
    }

    public org.kela.DemoProcessProcessInstance createInstance(java.lang.String businessKey, org.kie.kogito.Model value) {
        return this.createInstance(businessKey, (org.kela.DemoProcessModel) value);
    }

    public org.kela.DemoProcessProcessInstance createInstance(org.kie.api.runtime.process.WorkflowProcessInstance wpi) {
        return new org.kela.DemoProcessProcessInstance(this, this.createModel(), this.createProcessRuntime(), wpi);
    }

    public org.kela.DemoProcessProcessInstance createReadOnlyInstance(org.kie.api.runtime.process.WorkflowProcessInstance wpi) {
        return new org.kela.DemoProcessProcessInstance(this, this.createModel(), wpi);
    }

    public org.kie.api.definition.process.Process process() {
        RuleFlowProcessFactory factory = RuleFlowProcessFactory.createProcess("demoProcess");
        ...
        factory.name("demoProcess");
        factory.packageName("org.kela");
        factory.dynamic(false);
        factory.version("1.0");
        factory.visibility("Public");
        factory.addCompensationContext("demoProcess");
        ...
        endNode2.action(kcontext -> {
            kcontext.getProcessInstance().signalEvent("Compensation", "implicit:demoProcess");
        });
        ...
        workItemNode9.name("Step 1 (Service Call)");
        workItemNode9.workName("org.kela.Countries_getCountry_9_Handler");
        workItemNode9.workParameter("Interface", "org.kela.Countries");
        workItemNode9.workParameter("Operation", "getCountry");
        workItemNode9.workParameter("interfaceImplementationRef", "org.kela.Countries");
        workItemNode9.workParameter("operationImplementationRef", "getCountry");
        workItemNode9.workParameter("implementation", "Java");
        workItemNode9.inMapping("name", "userID");
        workItemNode9.done();
        workItemNode9.metaData("UniqueId", "_AF929E01-ABA6-44A2-B644-E6ADAB78555B");
        workItemNode9.metaData("Implementation", "Java");
        workItemNode9.metaData("elementname", "Step 1 (Service Call)");
        workItemNode9.metaData("Type", "Service Task");
        workItemNode9.metaData("OperationRef", "_AF929E01-ABA6-44A2-B644-E6ADAB78555B_ServiceOperation");
        workItemNode9.metaData("x", 224);
        workItemNode9.metaData("width", 154);
        workItemNode9.metaData("y", 112);
        ...
        boundaryEventNode11.metaData("x", 269);
