...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "demoProcess", name = "DemoProcess", hidden = false)
public class DemoProcessModel implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<DemoProcessModelOutput> {
    ...
    @Override()
    public DemoProcessModelOutput toModel() {
        DemoProcessModelOutput result = new DemoProcessModelOutput();
        result.setId(getId());
