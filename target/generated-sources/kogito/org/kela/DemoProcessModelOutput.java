...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "demoProcess", name = "DemoProcess", hidden = true)
public class DemoProcessModelOutput implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<DemoProcessModel> {
    ...
    @Override()
    public DemoProcessModel toModel() {
        DemoProcessModel result = new DemoProcessModel();
        result.setId(getId());
